...
A delayed transaction is a transaction with an additional information about an absolute game time unit. The amount to be transferred in this _delayed_ transaction has to be completed _on or before_ this absolute game time.
